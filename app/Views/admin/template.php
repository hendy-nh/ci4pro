...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?= base_url() ?>/template_admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
...
<body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?= base_url() ?>/template_admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?= base_url() ?>/template_admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Reviewers
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Input Data</a></li>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="<?= base_url() ?>/template_admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
    ...
    <!-- datepicker -->
    <script src="<?= base_url() ?>/template_admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
